...
public class FaceConfigActivity extends BaseActivity implements CustomDialog.OnDialogClickListener {
    ...
    private CustomDialog mDialog;   //自定义弹窗
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTv = findViewById(R.id.textView4);             //layout_search_title.xml   line 16
        mContext = this;
        ...
        relativeLayout = findViewById(R.id.all_relative);   //activity_face_config.xml line2
        ...
        if (displayHeight < displayWidth) {
            ...
            // 设置布局的宽和高
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(width, height);  //动态布局
            // 设置布局居中
    ...
    public void onConfirmClick(View view) {
        ...
        if ("search".equals(pageType)) {
            ...
            // 判断活体类型
            int liveType = SingleBaseConfig.getBaseConfig().getType();  //设置中的活体检测类型
