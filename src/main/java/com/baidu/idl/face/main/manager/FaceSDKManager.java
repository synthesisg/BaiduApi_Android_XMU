        ...
        future2 = es2.submit(new Runnable() {
            ...
            public void run() {
                ...
                if (liveCheckMode != 1) {
                    ...
                    LogUtils.e("lkdong", "rgb 活体检测通过");
                }else{
                    LogUtils.e("lkdong", "rgb 活体检测不通过");
                }

                LogUtils.e("lkdong", "liveCheckMode = "+liveCheckMode);
                ...
                if (liveCheckMode == 3 && nirData != null) {
                    ...
                    if (faceInfosIr != null && faceInfosIr.length > 0) {
                        ...
                        LogUtils.e("lkdong", "Ir 活体检测通过");
                    }else {
                        LogUtils.e("lkdong", "Ir 活体检测不通过");
                    }
                    nirInstance.destory();
                }
                ...
                if (liveCheckMode == 4 && depthData != null) {
                    ...
                    BDFaceImageInstance depthInstance = new BDFaceImageInstance(depthData, 640,
                            480, BDFaceSDKCommon.BDFaceImageType.BDFACE_IMAGE_TYPE_YUV_420,
                            0, 0);
