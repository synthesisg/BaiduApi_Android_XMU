...
public class WelcomeAdminActivity extends BaseActivity implements View.OnClickListener {

    private Context mContext;


    private Button btnDownload, btnUpdateFace,btnUpdateBase,btnInformation,btnLogout;
    private Button btnImport, btnManagement;
    @Override
    ...
    private void initView() {
        ...
        btnImport = findViewById(R.id.btn_h_import);
        btnManagement = findViewById(R.id.btn_h_management);
        ...
        if(PlatformUtils.getInstance().isLogin()==false||PlatformUtils.getInstance().getUser()==null)
        {
            ...
            Toast.makeText(WelcomeAdminActivity.this, "非法访问，请重新登录。", Toast.LENGTH_LONG).show();
            startActivity(new Intent(WelcomeAdminActivity.this, FrontPageActivity.class));
            finish();
        }
        ...
        try {
            ...
            switch (view.getId()) {
                ...
                case R.id.btn_download:
                    ...
                    startActivity(intent);
                    break;
                case R.id.btn_h_management:
                    LogUtils.d("[base]","btn_h_management");
                    startActivity(new Intent(mContext, FaceUserGroupListActivity.class));
                    break;
                case R.id.btn_h_import:
                    LogUtils.d("[base]","btn_h_import");
